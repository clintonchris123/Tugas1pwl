...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item {{ request()->is('admin/terkini') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/terkini">
                    <i class="fas fa-fw fa-newspaper"></i>
                    <span>postingan terkini</span></a>
            </li>
            </li>
            <li class="nav-item {{ request()->is('admin/populer') ? 'active' : ''}}">
                <a class="nav-link" href="/admin/populer">
                    <i class="fas fa-fw fa-newspaper"></i>
                    <span>postingan populer</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Clinton Christovel Simanullang</span>
                                <img class="img-profile rounded-circle"
                                    src="{{ asset('clinton.jpeg') }}">
                            </a>
